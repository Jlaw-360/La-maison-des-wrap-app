...
const workerCode = `// Cloudflare Worker for La Maison des Wraps
export default {
...
const wranglerConfig = `name = "la-maison-des-wraps"
...
console.log('Updated wrangler.toml with main = "worker.js"');
