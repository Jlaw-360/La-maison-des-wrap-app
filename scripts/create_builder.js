...
console.log("Creating scripts/build_mobile_app.js ...");
...
fs.writeFileSync('scripts/build_mobile_app.js', scriptContent);
console.log('scripts/build_mobile_app.js ready.');
